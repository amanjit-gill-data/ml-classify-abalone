...
mvn_test.t <- mvn(abalone.t, mvnTest = "mardia", univariateTest = "SW")
```
...
sk.final <- mvn(abalone.t, mvnTest = "mardia", univariateTest = "SW")$Descriptives %>% select(Skew, Kurtosis)
